...
int main(int argc, char *argv[])
{
	if (argc < 5)
	{
		std::cerr
			...
			<< "<icp_configruation>:\n\t" << "it was mainly implemented based on the ICP algorithm, which will execute based on this configuration file\n"
			<< "<output_folder>:\n\t" << "only one file will be saved in this folder, i.e., fine_matrix.txt. Furthermore, it will load a coarse matrix from this folder.\n"
			<< "like: program_name <reading_point_cloud> <reference_point_cloud> <icp_configruation> <output_folder> \n";
